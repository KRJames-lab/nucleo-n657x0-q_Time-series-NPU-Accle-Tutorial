...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "npu_conv2d"
...
#define LL_ATON_NETWORK_IN_1_SIZE_BYTES  (2000)

/************************** OUTPUTS *******************************************/
#define LL_ATON_NETWORK_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Quantize_76_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (1)
